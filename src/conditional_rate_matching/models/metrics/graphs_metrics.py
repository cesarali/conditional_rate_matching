...
from conditional_rate_matching.models.metrics.mmd2 import (
    compute_mmd,
    gaussian,
    gaussian_emd,
    process_tensor,
...
if __name__ == "__main__":
    ...
    results_ = eval_graph_list(graph_list_1, graph_list_2, methods=None, windows=False, orca_dir=ORCA_DIR_STANDARD)
    print(results_)
