...
class TemporalGraphConvNet(torch.nn.Module):
    def __init__(self, config, device):
        ...
        self.define_deep_models(config)
        self.to(device)
        self.expected_output_shape = [self.dimensions * self.dimensions, self.vocab_size]
    ...
    def define_deep_models(self, config):
        ...
        self.linear = nn.Linear(self.dim_hidden_x, self.dimensions * self.dimensions * self.vocab_size )
