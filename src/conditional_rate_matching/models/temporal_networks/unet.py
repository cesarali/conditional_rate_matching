...
from conditional_rate_matching.models.networks.fp16_util import convert_module_to_f16, convert_module_to_f32

from conditional_rate_matching.models.networks.nn import (
    avg_pool_nd,
    checkpoint,
    conv_nd,
    linear,
...
class UNetModelWrapper(UNetModel):
    def __init__(
        ...
        self.expected_output_shape = [1,28,28]
