...
path = "noise_to_mnist_unet_ConstantThermostat_gamma_0.25_max_0.0"
run = "run"
num_timesteps = 100
time_epsilon = 0.01
device = "cuda:0"
...
experiment_dir = os.path.join(results_path,"crm", path, run)
...
if not os.path.isfile(experiment_dir + "/bridge_example.png"):
