...
def CRM_single_run(experiment_name="nist",
                   experiment_dir=None,
                   thermostat=None,
    ...
    if dataset0 == "noise": crm_config.data0 = StatesDataloaderConfig(dirichlet_alpha=100., batch_size=batch_size)
    else: crm_config.data0 = NISTLoaderConfig(flatten=True if model=='mlp' else False, 
